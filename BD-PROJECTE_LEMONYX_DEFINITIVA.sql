...
-- Volcando datos para la tabla projectelemonyx.actors: ~1 rows (aproximadamente)
DELETE FROM `actors`;
...
-- Volcando datos para la tabla projectelemonyx.actuen: ~1 rows (aproximadamente)
DELETE FROM `actuen`;
...
-- Volcando datos para la tabla projectelemonyx.clients: ~2 rows (aproximadamente)
DELETE FROM `clients`;
...
-- Volcando datos para la tabla projectelemonyx.compte: ~2 rows (aproximadamente)
DELETE FROM `compte`;
INSERT INTO `compte` (`id_compte`, `usuari`, `contrassenya`, `data_alta`, `id_client`, `id_modalitat`) VALUES
	(7, 'prova', '1234', '2023-05-10', 25, 1),
	(8, 'alex', '1234', '2023-05-17', 26, 3);
...
-- Volcando datos para la tabla projectelemonyx.director: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla projectelemonyx.dirigeix_pel·licula: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla projectelemonyx.pertany: ~1 rows (aproximadamente)
DELETE FROM `pertany`;
