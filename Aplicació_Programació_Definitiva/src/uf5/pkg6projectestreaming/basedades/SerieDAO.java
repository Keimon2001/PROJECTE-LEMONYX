...
public class SerieDAO {
    ...
    public Serie consultaSerieBD(int id) {
        ...
        String sentenciaSql = "SELECT COUNT(e.id_produccio) numcapitols, SUM(e.durada) duradatotal FROM series s, episodi e "
    ...
    private String obtenirCategoria(int idProduccio) {
        ...
        String sentenciaSql = "SELECT cat.nom FROM genere cat, dirigeix_episodi pert, produccions pro "
                + "WHERE pert.id_produccio = ? AND pro.id_categoria = cat.id_categoria";
    ...
    private String obtenirDirector(int idProduccio) {
        ...
        String sentenciaSql = "SELECT dir.nom_director FROM dirigeix_episodi pert, director dir "
    ...
    private String obtenirActor(int idProduccio) {
        ...
        String sentenciaSql = "SELECT protagonista FROM dirigeix_episodi pert, actors act "
                + "WHERE pert.id_produccio = ? AND pert.protagonista = act.nom_actor";
        ...
        try ( PreparedStatement ps = con.prepareStatement(sentenciaSql)) {
            ...
            if (rs.next()) {
                ...
                return rs.getString("protagonista");
            }
        } catch (SQLException sqle) {
            sqle.printStackTrace();
        }
