...
public class PeliculaDAO {
    ...
    private String obtenirDirector(int idProduccio) {
        ...
        String sentenciaSql = "SELECT d.nom_director FROM dirigeix_pel·licula dp, director d "
    ...
    private String obtenirCategoria(int idProduccio) {
        ...
        String sentenciaSql = "SELECT d.nom FROM pertany dp, genere d "
    ...
    private String obtenirActor(int idProduccio) {
        ...
        String sentenciaSql = "SELECT d.nom_actor FROM actuen dp, actors d "
