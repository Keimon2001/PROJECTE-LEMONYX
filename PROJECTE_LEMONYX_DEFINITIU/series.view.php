...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/estilsSeries.css">
...
<body>
    ...
    <header>
        ...
        <ul class="navbar">
                ...
                <li><a href="pelis.view.php">Pelicules</a></li>
                <li><a href="series.view.php" class="actiu">Series</a></li>
    ...
    <div id="contingut">
        ...
        <div id="cercar">
            ...
            <input type="text" id="myInput" placeholder="Busca la teva serie" title="Type in a name">
    ...
    <script src="js/provaAjaxSeries.js"></script>
    <script src="js/popup.js"></script>
    <script src="js/gridSeries.js"></script>
