...
<body>
    ...
    <header>
        ...
        <ul class="navbar">
                ...
                <li><a href="series.view.php" class="actiu">Sèries</a></li>
    ...
    <div id="contingut">
        ...
        <div id="cercar">
            ...
            <input type="text" id="myInput" placeholder="Busca la teva sèrie" title="Type in a name">
