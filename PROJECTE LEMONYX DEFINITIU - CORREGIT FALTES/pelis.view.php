...
<head>
    <meta charset="UTF-8">
    <title>Pel·lícules | Lemonyx</title>
...
<body>
    <header>
        ...
        <ul class="navbar">
                ...
                <li><a href="pelis.view.php" class="actiu">Pel·lícules</a></li>
    ...
    <div id="contingut">
        ...
        <div id="cercar">
            ...
            <input type="text" id="myInput" placeholder="Busca la teva pel·lícula" title="Type in a name">
        </div>
