								...
								<div class="card-back">
									<div class="center-wrap">
										<div class="section text-center">
                                            ...
                                            <div class="form-group mt-2">
												<input type="tel" class="form-style" name="tarjeta" id="tarjeta" placeholder="Número targeta">
												<i class="input-icon fa fa-credit-card"></i>
											</div>                                           
										
											<div class="form-group mt-2">
												<input type="password" class="form-style" name="psswd" id="psswd" placeholder="Contrassenya">
												<i class="input-icon uil uil-lock-alt"></i>
											</div>

											<div class="form-group mt-2">
												<input type="password" class="form-style" name="confirm_psswd" id="confirm_psswd" placeholder="Confirma la contrassenya">
												<i class="input-icon uil uil-lock-alt"></i>
